(() => {
	...
	const e = document.querySelector('.burger'),
		t = document.querySelector('.burger__line'),
		s = document.querySelector('.nav'),
		i = document.querySelector('body'),
		a = document.querySelectorAll('.nav__item');
	function r(e) {
					...
					void 0 !== r &&
						...
						(m(e[i]) && m(a[i])
							? a[i].__swiper__
								...
								: f(e[i], a[i])
							: !m(e[i]) && m(a[i])
							? ((e[i] = {}), a[i].__swiper__ ? (e[i] = a[i]) : f(e[i], a[i]))
							: (e[i] = a[i]));
				}
			}
		}
	...
	var _ = {
		updateSize: function () {
			...
			(t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth),
				...
				(0 === t && e.isHorizontal()) ||
					(0 === s && e.isVertical()) ||
					((t =
						t - parseInt(y(i, 'padding-left') || 0, 10) - parseInt(y(i, 'padding-right') || 0, 10)),
					(s =
						s - parseInt(y(i, 'padding-top') || 0, 10) - parseInt(y(i, 'padding-bottom') || 0, 10)),
					Number.isNaN(t) && (t = 0),
					Number.isNaN(s) && (s = 0),
		...
		updateSlides: function () {
			...
			'string' == typeof T && T.indexOf('%') >= 0
				...
				s.centeredSlides &&
					s.cssMode &&
					(h(i, '--swiper-centered-offset-before', ''), h(i, '--swiper-centered-offset-after', ''));
				...
				if (
					...
					if ('auto' === s.slidesPerView) {
						...
						if (
							...
							P = e.isHorizontal() ? E(a, 'width', !0) : E(a, 'height', !0);
						else {
							const e = t(r, 'width'),
								s = t(r, 'padding-left'),
								i = t(r, 'padding-right'),
					...
					c[i] && (c[i].swiperSlideSize = P),
						...
						s.centeredSlides
							? ((x = x + P / 2 + C / 2 + T),
							  ...
							  m.push(x))
							: (s.roundLengths && (x = Math.floor(x)),
							  (M - Math.min(e.params.slidesPerGroupSkip, M)) % e.params.slidesPerGroup == 0 &&
									u.push(x),
							  m.push(x),
							  (x = x + P + T)),
						(e.virtualSize += P + T),
			...
			if (
				...
				h(i, '--swiper-centered-offset-before', -u[0] + 'px'),
					h(i, '--swiper-centered-offset-after', e.size / 2 - f[f.length - 1] / 2 + 'px');
		...
		updateSlidesProgress: function (e) {
			...
			for (let e = 0; e < i.length; e += 1) {
				...
				h && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e)),
					O(o, h, s.slideVisibleClass),
					O(o, f, s.slideFullyVisibleClass),
					(o.progress = a ? -c : c),
	...
	function $(e) {
		...
		let l = i;
		if (
			(l || (l = r > n ? 'next' : r < n ? 'prev' : 'reset'), t.emit(`transition${a}`), s && r !== n)
		) {
	...
	var B = {
				...
				if (l.cssMode) {
					...
					if (0 === t)
						...
						if (!r.support.smoothScroll)
							return g({ swiper: r, targetPosition: s, side: e ? 'left' : 'top' }), !0;
				...
				if (a.params.loop)
					if (a.virtual && a.params.virtual.enabled) n += a.virtual.slidesBefore;
						...
						if (r) {
							...
							e = a.slides.filter(e => 1 * e.getAttribute('data-swiper-slide-index') === t)[0]
								.column;
						...
						if (r) {
							...
							n = a.slides.filter(t => 1 * t.getAttribute('data-swiper-slide-index') === e)[0]
								.column;
			...
			slideToClosest: function (e, t, s, i) {
				...
				return (
					(r = Math.max(r, 0)), (r = Math.min(r, a.slidesGrid.length - 1)), a.slideTo(r, e, t, s)
				);
			},
		...
		F = {
			...
			loopFix: function (e) {
				...
				d.length < h + v
					...
					: b &&
					  'row' === m.grid.fill &&
					  w('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
				const y = [],
					S = [];
				let T = o.activeIndex;
				void 0 === r
				...
				const L = b ? Math.ceil(d.length / m.grid.rows) : d.length,
					P = (b ? d[r].column : r) + (f && void 0 === a ? -h / 2 + 0.5 : 0);
				if (P < v) {
					C = Math.max(v - P, g);
	...
	function N(e, t, s) {
		...
		return (
			!r || !(s <= n || s >= i.innerWidth - n) || ('prevent' === r && (t.preventDefault(), !0))
		);
	}
	function V(e) {
		const t = this,
		...
		let w = !0;
		d.matches(a.focusableElements) && ((w = !1), 'SELECT' === d.nodeName && (a.isTouched = !1)),
			s.activeElement &&
				s.activeElement.matches(a.focusableElements) &&
				s.activeElement !== d &&
				('mouse' === i.pointerType ||
					('mouse' !== i.pointerType && !d.matches(a.focusableElements))) &&
			...
			g > 0
				? (b &&
						...
						i.currentTranslate >
							(a.centeredSlides
								? s.minTranslate() -
								  ...
								  ('auto' !== a.slidesPerView && s.slides.length - a.slidesPerView >= 2
				  ...
				  i.currentTranslate > s.minTranslate() &&
						...
						a.resistance &&
							(i.currentTranslate =
								s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + g) ** T)))
				: g < 0 &&
				  (b &&
						y &&
						i.allowThresholdMove &&
				  ...
				  i.currentTranslate < s.maxTranslate() &&
						...
						a.resistance &&
							(i.currentTranslate =
								s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - g) ** T))),
	...
	function R(e) {
		...
		let i,
			a = e;
		if (
			(a.originalEvent && (a = a.originalEvent), 'touchend' === a.type || 'touchcancel' === a.type)
		) {
			if (
		...
		if (t.allowClick) {
			...
			t.updateClickedSlide((e && e[0]) || a.target, e),
				t.emit('tap click', a),
				m < 300 && c - s.lastClickTime < 300 && t.emit('doubleTap doubleClick', a);
		}
		if (
			((s.lastClickTime = u()),
			p(() => {
		...
		for (let e = 0; e < o.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
			...
			void 0 !== o[e + t]
				...
				: (h || f >= o[e]) && ((g = e), (v = o[o.length - 1] - o[o.length - 2]));
		}
		let w = null,
			b = null;
		r.rewind &&
		...
		if (m > r.longSwipesMs) {
			...
			'next' === t.swipeDirection &&
				(y >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? w : g + S) : t.slideTo(g)),
				...
				translateTo: function (e, t, s, i, a) {
					...
					if (((c = i && e > o ? o : i && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
						...
						if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
							...
							if (!r.support.smoothScroll)
								return g({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0;
	...
	class te {
		...
		getSlideIndex(e) {
			const { slidesEl: t, params: s } = this,
				i = S(v(t, `.${s.slideClass}, swiper-slide`)[0]);
			return S(e) - i;
		}
	...
	function ae(e) {
		...
		function c(e) {
			...
			if (t.params.loop) {
				...
				const e =
					((a = t.realIndex),
					(r = i),
					(r %= n = t.slides.length) == 1 + (a %= n) ? 'next' : r === a - 1 ? 'previous' : void 0);
				...
				if (
					...
					a.forEach(e => {
						...
						a === i
							...
							s.dynamicBullets &&
								(a >= o && a <= p && e.classList.add(...`${s.bulletActiveClass}-main`.split(' ')),
								a === o && d(e, 'prev'),
								a === p && d(e, 'next'));
					});
				else {
			...
			'string' == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
				...
				s &&
					...
					(t.params.uniqueNavElements &&
						...
						s.length > 1 && (s = s.filter(e => T(e, '.swiper')[0] === t.el)[0])),
		...
		const h = () => {
			...
			let { el: e } = t.pagination;
			e &&
				((e = x(e)), e.forEach(e => e.classList.add(t.params.pagination.paginationDisabledClass))),
				f();
		};
		...
		r('init', () => {
			i.params.autoplay.enabled &&
				(i.params.autoplay.pauseOnMouseEnter &&
					(i.el.addEventListener('pointerenter', P), i.el.addEventListener('pointerleave', k)),
				o().addEventListener('visibilitychange', L),
				E());
		}),
			r('destroy', () => {
				i.el &&
					...
					o().removeEventListener('visibilitychange', L),
	...
	Object.keys(Z).forEach(e => {
		...
		e.addEventListener('click', () => {
			t.classList.toggle('line--hide'),
				e.classList.toggle('burger--transform'),
				s.classList.toggle('nav--hide'),
				i.classList.toggle('no-scroll');
		}),
		a.forEach(a => {
			a.addEventListener('click', () => {
				t.classList.remove('line--hide'),
					e.classList.remove('burger--transform'),
					s.classList.remove('nav--hide'),
					i.classList.remove('no-scroll');
			});
		}),
		new te('.hero-slider__left', {
			modules: [ae, re],
			loop: !0,
			autoplay: { delay: 5e3 },
			pagination: { el: '.hero__pagination', clickable: !0 },
		}),
		new te('.hero-slider__right', {
			modules: [ae, re],
			loop: !0,
			autoplay: { delay: 5e3 },
			pagination: { el: '.hero__pagination', clickable: !0 },
		...
		new te('.team__slider', {
			modules: [
				...
				function (e) {
					...
					function c() {
						...
						let s = r(e.nextEl),
							i = r(e.prevEl);
						Object.assign(t.navigation, { nextEl: s, prevEl: i }), (s = x(s)), (i = x(i));
						const a = (s, i) => {
			...
			loop: !0,
			autoplay: { delay: 5e3 },
			pagination: { el: '.team__pagination', clickable: !0 },
			navigation: { prevEl: '.team__arrow-prev', nextEl: '.team__arrow-next' },
		});
})();
